...
def lambda_handler(event, context):
    ...
    # twilio expets an XML content for generating the voice. This is written in something strange called TwiML
    ...
    # frustratingly, lambda can only send JSON content so we are wrapping it in the dummy JSON variable
